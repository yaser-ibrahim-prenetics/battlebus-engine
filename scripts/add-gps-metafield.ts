...
const SHOPIFY_SHOP_DOMAIN = (process.env.SHOPIFY_IM8_SHOP_DOMAIN || 'im8health.myshopify.com').replace('https://', '');
...
console.log('  SHOPIFY_ACCESS_TOKEN:', SHOPIFY_ACCESS_TOKEN ? `${SHOPIFY_ACCESS_TOKEN.substring(0, 10)}...` : 'NOT SET');
console.log('');
