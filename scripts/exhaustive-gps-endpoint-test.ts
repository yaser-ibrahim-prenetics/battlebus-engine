...
async function testEndpoint(endpoint: string, data: Record<string, unknown>): Promise<TestResult> {
...
async function main() {
  ...
  const endpoints: { path: string; data: Record<string, unknown>; description: string }[] = [
    ...
    {
      path: "/openapi/v1/outboundOrder/detail",
      data: { outboundOrderNoList: [] },
      description: "Get outbound order details",
    },
    {
      path: "/openapi/v1/outboundOrder/list",
      data: { page: 1, pageSize: 10 },
      description: "List outbound orders",
    },
    {
      path: "/openapi/v1/outboundOrder/cancel",
      data: { orderNo: "TEST" },
      description: "Cancel outbound order",
    },
    {
      path: "/openapi/v1/outboundOrder/query",
      data: { page: 1, pageSize: 10 },
      description: "Query outbound orders",
    },
    {
      path: "/openapi/v1/outboundOrder/status",
      data: { orderNoList: [] },
      description: "Get order status",
    },
    {
      path: "/openapi/v1/outboundOrder/tracking",
      data: { orderNo: "TEST" },
    ...
    {
      path: "/openapi/v1/inboundOrder/detail",
      data: { inboundOrderNoList: [] },
      description: "Get inbound order details",
    },
    {
      path: "/openapi/v1/inboundOrder/list",
      data: { page: 1, pageSize: 10 },
      description: "List inbound orders",
    },
    {
      path: "/openapi/v1/inboundOrder/query",
      data: { page: 1, pageSize: 10 },
      description: "Query inbound orders",
    },

    // ==================== INVENTORY ====================
    {
      path: "/openapi/v1/inventory/list",
      data: { page: 1, pageSize: 10 },
      description: "List inventory",
    },
    {
      path: "/openapi/v1/inventory/query",
      data: { page: 1, pageSize: 10 },
      description: "Query inventory",
    },
    {
      path: "/openapi/v1/inventory/detail",
      data: { skuList: [] },
      description: "Get inventory details",
    },
    {
      path: "/openapi/v1/inventory/snapshot",
      data: { page: 1, pageSize: 10 },
      description: "Inventory snapshot",
    },
    {
      path: "/openapi/v1/inventory/history",
      data: { page: 1, pageSize: 10 },
    ...
    {
      path: "/openapi/v1/warehouse/detail",
      data: { whCode: "LHR" },
    ...
    // ==================== SHIPMENT/LOGISTICS ====================
    {
      path: "/openapi/v1/shipment/list",
      data: { page: 1, pageSize: 10 },
      description: "List shipments",
    },
    {
      path: "/openapi/v1/shipment/detail",
      data: { shipmentNoList: [] },
      description: "Shipment details",
    },
    {
      path: "/openapi/v1/shipment/tracking",
      data: { trackingNo: "TEST" },
    ...
    // ==================== RETURN ====================
    {
      path: "/openapi/v1/return/list",
      data: { page: 1, pageSize: 10 },
      description: "List returns",
    },
    { path: "/openapi/v1/return/create", data: [], description: "Create return" },
    {
      path: "/openapi/v1/return/detail",
      data: { returnOrderNoList: [] },
      description: "Return details",
    },
    {
      path: "/openapi/v1/returnOrder/list",
      data: { page: 1, pageSize: 10 },
    ...
    // ==================== FBA ====================
    {
      path: "/openapi/v1/fba/inventory",
      data: { page: 1, pageSize: 10 },
      description: "FBA inventory",
    },
    {
      path: "/openapi/v1/fba/shipment/list",
      data: { page: 1, pageSize: 10 },
      description: "FBA shipments",
    },
    { path: "/openapi/v1/fba/shipment/create", data: [], description: "Create FBA shipment" },

    // ==================== TRANSFER ====================
    {
      path: "/openapi/v1/transfer/list",
      data: { page: 1, pageSize: 10 },
    ...
    // ==================== REPORT ====================
    {
      path: "/openapi/v1/report/inventory",
      data: { page: 1, pageSize: 10 },
      description: "Inventory report",
    },
    {
      path: "/openapi/v1/report/stock",
      data: { page: 1, pageSize: 10 },
      description: "Stock report",
    },
    {
      path: "/openapi/v1/report/outbound",
      data: { page: 1, pageSize: 10 },
      description: "Outbound report",
    },

    // ==================== MISC ====================
    {
      path: "/openapi/v1/order/list",
      data: { page: 1, pageSize: 10 },
      description: "List orders (generic)",
    },
    {
      path: "/openapi/v1/order/detail",
      data: { orderNoList: [] },
      description: "Order details (generic)",
    },
