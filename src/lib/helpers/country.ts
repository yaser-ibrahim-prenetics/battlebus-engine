...
// ============================================================================
// Ported from spock-store src/component/countrycode.ts

/**
 * ISO 3166-1 alpha-2 to alpha-3 country code mapping
 * D365 requires ISO3 country codes
 */
 ...
 * D365 requires ISO3 country codes
 */
export function getCountryISO3(iso2Code: string): string {
  const upperCode = iso2Code?.toUpperCase() || "";
  return ISO2_TO_ISO3[upperCode] || upperCode;
}

/**
 * Get country name from shipping address
 */
export function getCountry(order: {
